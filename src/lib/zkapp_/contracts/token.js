...
import { AccountUpdate, Bool, Int64, method, Mina, Permissions, PublicKey, SmartContract, UInt64, VerificationKey } from 'snarkyjs';
export class TokenContract extends SmartContract {
    ...
    // create a zkapp which can hold this token
